package com.zzz.game.control;

import android.util.Log;
import android.view.MotionEvent;
import com.zzz.game.bean.Plant;
import com.zzz.game.bean.impl.PeacePlant;
import com.zzz.game.bean.impl.PlantNut;
import com.zzz.game.bean.impl.PrimaryZombies;
import com.zzz.game.layer.FightLayer;
import com.zzz.game.layer.FightLine;
...
public class GameController {
	...
	private ShowPlant currentShowPlant;// չʾ��ֲ�
...
static{
	...
	public void handlerTouch(MotionEvent event){
		if(CommonUtil.isClicke(event, layer, layer.getChildByTag(FightLayer.TAG_CHOSE))){
			...
			if(currentShowPlant !=null){//ֻ��ѡ��ֲ��ſ��Է���
	...
	public boolean checkField(CGPoint touch){
		...
		int line = (int)(CCDirector.sharedDirector().winSize().height-touch.y)/54;
		if(row>=1&&row<=9){
			if(line>=1&&line<=5){
